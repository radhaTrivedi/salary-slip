    ...
    <aside className="hidden md:flex md:w-64 md:flex-col md:shrink-0 bg-ink-900 text-paper-100 min-h-screen sticky top-0">
      <div className="px-6 py-7 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          ...
          />
          <div>
            <p className="font-display text-base leading-tight tracking-tight">ROBO+ EduTech</p>
            <p className="text-[11px] text-ink-300 tracking-wide uppercase">Payroll register</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-5 border-t border-white/10">
        <p className="text-[11px] text-ink-300">
          Working days are fixed at <span className="text-paper-100 font-medium">30 / month</span>.
        </p>
        {user && (
          <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between">
            <div>
              <p className="text-xs text-ink-300">Signed in as</p>
              <p className="text-sm font-medium text-paper-100">{user.username}</p>
            </div>
            <button
